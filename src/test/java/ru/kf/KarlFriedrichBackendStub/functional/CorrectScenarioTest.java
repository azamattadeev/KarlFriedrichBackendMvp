package ru.kf.KarlFriedrichBackendStub.functional;
...
public class CorrectScenarioTest {
    ...
    public void correctScenarioTest() throws Exception {
        ...
        MenuItemPreviewDto[] menuItemPreviews = JsonConverter.mapFromJson(
                mvcResult.getResponse().getContentAsString(), MenuItemPreviewDto[].class);
